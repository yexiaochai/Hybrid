package com.baidu.hybrid.impl.header;
...
import com.baidu.kuai.actionbar.Action;
import com.baidu.kuai.actionbar.ImageAction;
import com.baidu.kuai.actionbar.TextAction;
...
/**
 * Hybrid Header Controller
 * TODO
 */
public final class HyBridHeaderController {
    ...
    private HyBridHeaderController(ViewSwitcher header) {
     ...
     * @return controller
     */
    public static HyBridHeaderController fromView(View view) {
        ...
        return new HyBridHeaderController(viewSwitcher);
    }
